...
import static com.barrybecker4.game.twoplayer.gomoku.ExpectedSearchableResults.*;
 ...
 * @author Barry Becker
 */
public class GoMokuSearchableTest extends TwoPlayerSearchableBaseTst {

    @Override
    protected ISearchableHelper createSearchableHelper() {
        return new GoMokuHelper();
    }
