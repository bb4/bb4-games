...
public class BestMoveFinderTest {
    ...
    private BestMoveFinder<TwoPlayerMove> finder;

    private BestMovesSearchOptions options;
    private MoveList<TwoPlayerMove> mList;
    ...
    public void testNoMovesReturnedWhenThresholds0() {
        ...
        mList = finder.getBestMoves(createSimpleThreeMoveList(PLAYER2));
    ...
    public void testNoMovesReturnedWhenNoMovesToSelectFrom() {
        ...
        mList = finder.getBestMoves(new MoveList<TwoPlayerMove>());
    ...
    public void testMinBestOfOneP1() {
        ...
        mList = finder.getBestMoves(createSimpleThreeMoveList(PLAYER1));
        assertEquals("Unexpected number of best moves found", 1, mList.getNumMoves());
    ...
    @Test
    public void testBestMinSmallerThanTotalP1() {
        options.setPercentLessThanBestThresh(0);
        options.setPercentageBestMoves(0);
        options.setMinBestMoves(5);

        mList = finder.getBestMoves(createSixMoveListWithNegatives(PLAYER1));
    ...
    public void testBest20PercentMovesP1() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(-10, 10), PLAYER1));
    ...
    public void testBest20PercentMovesP2() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(-10, 10), PLAYER2));
        assertEquals("Unexpected number of best moves found", 4, mList.getNumMoves());
        assertEquals("Unexpected value", -10, mList.getFirstMove().getValue());
    }
    ...
    public void testBest25PercentLessThanBestThreshMovesP1() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(-20, 20), PLAYER1));
    ...
    public void testBest25PercentLessThanBestThreshMovesP1WhenAllPositive() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(1, 40), PLAYER1));
    ...
    public void testBest25PercentLessThanBestThreshMovesP2WhenAllPositive() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(1, 40), PLAYER2));
        assertEquals("Unexpected number of best moves found", 10, mList.getNumMoves());
    ...
    public void testBest25PercentLessThanBestThreshMovesP1WhenAllNegative() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(-40, 1), PLAYER1));
        assertEquals("Unexpected number of best moves found", 11, mList.getNumMoves());
        assertEquals("Unexpected value", 1, mList.getFirstMove().getValue());
    }

    @Test
    public void testBest30PercentLessThanBestThreshMovesP1() {
        options.setPercentLessThanBestThresh(30);
        options.setPercentageBestMoves(0);
        options.setMinBestMoves(1);

        mList = finder.getBestMoves(createSixMoveListWithNegatives(PLAYER1));
        assertEquals("Unexpected number of best moves found", 4, mList.getNumMoves());
        assertEquals("Unexpected value", 50, mList.getFirstMove().getValue());
    }

    @Test
    public void testBest30PercentLessThanBestThreshMovesP2() {
        options.setPercentLessThanBestThresh(30);
        options.setPercentageBestMoves(0);
        options.setMinBestMoves(1);

        mList = finder.getBestMoves(createSixMoveListWithNegatives(PLAYER2));
        assertEquals("Unexpected number of best moves found", 1, mList.getNumMoves());
        assertEquals("Unexpected value", -550, mList.getFirstMove().getValue());
    }
    ...
    public void testBest25PercentLessThanBestThreshMovesP2WhenAllNegative() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(-40, 1), PLAYER2));
        assertEquals("Unexpected number of best moves found", 11, mList.getNumMoves());
        assertEquals("Unexpected value", -40, mList.getFirstMove().getValue());
    }
    ...
    public void testBest20PercentLessThanBestThreshMovesP1() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(-10, 9), PLAYER1));
        assertEquals("Unexpected number of best moves found", 4, mList.getNumMoves());
    ...
    public void testBest20PercentLessThanBestThreshMovesP2() {
        ...
        mList = finder.getBestMoves(createRangeMoveList(new Range(-10, 9), PLAYER2));
        assertEquals("Unexpected number of best moves found", 4, mList.getNumMoves());
        assertEquals("Unexpected value", -10, mList.getFirstMove().getValue());
    }
    ...
    public void test50PercentLessThanBest5P1() {
        ...
        mList = finder.getBestMoves(createSimpleFiveMoveList(PLAYER1));
        assertEquals("Unexpected number of best moves found", 1, mList.getNumMoves());
    ...
    public void test50PercentLessThanBest5P2() {
        ...
        mList = finder.getBestMoves(createSimpleFiveMoveList(PLAYER2));
        assertEquals("Unexpected number of best moves found", 4, mList.getNumMoves());
    ...
    public void test50PercentLessThanBestWithDuplicatesP1() {
        ...
        mList = finder.getBestMoves(createMoveListWithDuplicateScores(PLAYER1));
        assertEquals("Unexpected number of best moves found", 1, mList.getNumMoves());
        assertEquals("Unexpected value", 1000, mList.getFirstMove().getValue());
    }
    ...
    public void test50PercentLessThanBestWithDuplicatesP2() {
        ...
        mList = finder.getBestMoves(createMoveListWithDuplicateScores(PLAYER2));
        assertEquals("Unexpected number of best moves found", 3, mList.getNumMoves());
        assertEquals("Unexpected value", 5, mList.getFirstMove().getValue());
    }
    ...
    public void testGetAllWhen100PercentLessThanBestP2() {
     ...
     private MoveList<TwoPlayerMove> createSimpleThreeMoveList(boolean player1) {
    ...
    private MoveList<TwoPlayerMove> createSimpleFiveMoveList(boolean player1) {
        MoveList<TwoPlayerMove> moveList = new MoveList<>();
        ...
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 5), 50, new GamePiece(player1)));
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 6), -5, new GamePiece(player1)));
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 4), 5, new GamePiece(player1)));
        return moveList;
    }

    private MoveList<TwoPlayerMove> createMoveListWithDuplicateScores(boolean player1) {
        MoveList<TwoPlayerMove> moveList = new MoveList<>();
        ...
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 5), 500, new GamePiece(player1)));
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 4), 5, new GamePiece(player1)));
        return moveList;
    }

    private MoveList<TwoPlayerMove> createSixMoveListWithNegatives(boolean player1) {
        MoveList<TwoPlayerMove> moveList = new MoveList<>();
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 3), -10, new GamePiece(player1)));
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 2), -550, new GamePiece(player1)));
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 7), -50, new GamePiece(player1)));
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 5), -250, new GamePiece(player1)));
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 8), 50, new GamePiece(player1)));
        moveList.add(TwoPlayerMoveStub.createMove(new ByteLocation(1, 4), -5, new GamePiece(player1)));
        return moveList;
    }
