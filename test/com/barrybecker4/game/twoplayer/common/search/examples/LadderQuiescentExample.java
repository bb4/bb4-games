...
public class LadderQuiescentExample extends AbstractGameTreeExample  {
    ...
    public LadderQuiescentExample(boolean player1PlaysNext) {
        ...
        move1010.setCausesUrgency(true);
        ...
        move1010000.setCausesUrgency(true);
