...
public class UnionFindTemp {
    ...
    public static UnionFindTemp create(InputStream in) {
        Scanner stdIn = new Scanner(in);
        int n = stdIn.nextInt();
        UnionFindTemp uf = new UnionFindTemp(n);
        while (stdIn.hasNext()) {
            int p = stdIn.nextInt();
            int q = stdIn.nextInt();
            if (!uf.connected(p, q)) {
    ...
    public static void main(String[] args) {
        UnionFindTemp uf = UnionFindTemp.create(System.in);
